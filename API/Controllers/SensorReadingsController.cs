...
public class SensorReadingController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult<ApiResponse<SensorDataResponse>>> AddReading([FromRoute(Name = "id")] string deviceId, SensorDataRequest request)
    {
        SensorDataResponse reading = await _sensorService.AddReadingAsync(deviceId, request);
    ...
    [HttpGet]
    public async Task<ActionResult<ApiResponse<List<SensorDataResponse>>>> GetAllReadings([FromRoute(Name = "id")] string deviceId)
    {
    ...
    [HttpGet("latest")]
    public async Task<ActionResult<ApiResponse<SensorDataResponse>>> GetLatestReading([FromRoute(Name = "id")] string deviceId)
    {
